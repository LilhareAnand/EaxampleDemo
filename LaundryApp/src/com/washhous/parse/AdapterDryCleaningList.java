...
public class AdapterDryCleaningList extends BaseAdapter {
	...
	public AdapterDryCleaningList(Activity dryCleanPageList,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(dryCleaningItems.get(position).getItemName().equals("Wool/Down coat"))
		{
			itemString = "" + dryCleaningItems.get(position).getItemName() + "($ "
					+ dryCleaningItems.get(position).getPrice()+" "+" and UP" + ")";
		}
		else
		{
		itemString = "" + dryCleaningItems.get(position).getItemName() + "($ "
